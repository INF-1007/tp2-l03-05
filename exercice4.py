...
def affecter_equipement(salle, position):
    ...
    nouvelle = [rangee[:] for rangee in salle]  
...
def generer_rapport_etat(salle):
    ...
    total_equipements = (rapport['disponibles_2'] + rapport['disponibles_4'] +
                         rapport['utilises_2'] + rapport['utilises_4'] +
                         rapport['maintenance_2'] + rapport['maintenance_4'])

    if total_equipements > 0:
        rapport['taux_indisponibilite'] = (rapport['utilises_2'] + rapport['utilises_4'] + rapport['maintenance_2'] + rapport['maintenance_4']) / total_equipements
    else:
